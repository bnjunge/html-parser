...
**PHP DOM HTML Parser** uses built-in [PHP DOM extension](http://php.net/manual/en/book.dom.php) to process your requests, it is a good alternative to [PHP Simple HTML DOM Parser](http://simplehtmldom.sourceforge.net/)
